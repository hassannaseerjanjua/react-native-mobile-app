...
type LocaleString =
  ...
  | 'ALREADY_CLAIMED'
  | 'AVAILABLE_ONCE_EVERY_24_HOURS_PER_STORE'
  | 'YOU_CAN_STILL_CLAIM_FROM_ANY_OTHER_STORE'
  | 'EXPLORE_OTHER_CATCH'
  | 'P_LETSSWAPGIFTS'
  | 'P_SCANTOGETME'
  | 'P_NOUSERIDAVAILABLE'
  | 'OCCASSIONS_MY_BIRTHDAY'
  | 'OCC_EVENT_NAME'
  | 'INBOX_TIME_JUST_NOW'
  | 'INBOX_TIME_YEAR_ONE'
  | 'INBOX_TIME_YEAR_OTHER'
  | 'INBOX_TIME_MONTH_ONE'
  | 'INBOX_TIME_MONTH_OTHER'
  | 'INBOX_TIME_WEEK_ONE'
  | 'INBOX_TIME_WEEK_OTHER'
  | 'INBOX_TIME_DAY_ONE'
  | 'INBOX_TIME_DAY_OTHER'
  | 'INBOX_TIME_HOUR_ONE'
  | 'INBOX_TIME_HOUR_OTHER'
  | 'INBOX_TIME_MINUTE_ONE'
  | 'INBOX_TIME_MINUTE_OTHER'
  ...
  | 'LOCATION_ADDRESS_DETAILS_MESSAGE'
  ...
  | 'INBOX_CONTINUE'
  | 'INBOX_DELIVERY'
  | 'INBOX_STORE_LOCATION_NOT_AVAILABLE'
  | 'INBOX_GIFT_LINK_LABEL'
  | 'INBOX_GIFT_LINK_TITLE'
  | 'INBOX_GIFT_ALREADY_REDEEMED'
  | 'INBOX_REDEEMED'
  | 'INBOX_MY_EMPLOYEES'
  | 'INBOX_ORDER_INFO_MISSING'
  | 'INBOX_SELECT_AT_LEAST_ONE_ITEM'
  | 'SEARCH_INVITE'
  | 'SEARCH_INVITE_MESSAGE'
  | 'SEARCH_INVITE_TITLE'
  | 'SEARCH_VERIFYING_CONTACTS'
  | 'SEARCH_LOADING_CONTACTS'
  | 'OCCASIONS_REQUIRED'
  | 'OCCASIONS_NO_OCCASIONS_FOUND'
  | 'OCCASIONS_DELETE_OCCASION'
  | 'OCCASIONS_DELETE_CONFIRM_MESSAGE'
  | 'OCCASIONS_DELETE'
  | 'PROFILE_IMAGE_VIEWER_TITLE'
  | 'PROFILE_IMAGE_VIEWER_DELETE_IMAGE'
  | 'PROFILE_IMAGE_VIEWER_DELETE_PHOTO'
  | 'PROFILE_IMAGE_VIEWER_DELETE_OCCASION_IMAGE_CONFIRM'
  | 'PROFILE_IMAGE_VIEWER_DELETE_PHOTO_CONFIRM'
  | 'PROFILE_IMAGE_VIEWER_DELETE'
  | 'PROFILE_GIFT_LINK_TITLE'
  | 'PROFILE_MY_EMPLOYEES'
  | 'PROFILE_CHANGE_PHOTO'
  | 'PROFILE_ADD_PHOTO'
  | 'PROFILE_REMOVE_PHOTO'
  | 'SELECT_CITY_TITLE'
  | 'SELECT_CITY_NO_CITIES_FOUND'
  | 'SEND_GIFT_MY_EMPLOYEES'
  | 'SEND_GIFT_CANCEL'
  | 'SEND_GIFT_SELECT'
  ...
  | 'COMP_PLAY'
  | 'COMP_UPLOAD'
  | 'COMP_SEARCH_PLACEHOLDER'
  | 'COMP_SELECT_OPTION'
  | 'COMP_SELECT_OPTION_LABEL'
  | 'COMP_IMAGE_LOAD_FAILED'
  | 'COMP_NO_IMAGES_FOUND'
  | 'COMP_NOT_AVAILABLE'
  | 'S_DELETE_ACCOUNT'
  ...
  | 'COMP_QTY'
  | 'HOME_GIFT_ONE_GET_ONE_STATUS'|'AU_PHONE_NUMBER_LABEL';
