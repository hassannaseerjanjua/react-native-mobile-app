...
export const Text = (props: TextProps) => {
  ...
  return (
    <RNText
      ...
      style={[{ writingDirection: 'ltr' }, props.style, scriptFontStyle]}
    />
  );
};
...
export const TextInput = React.forwardRef<RNTextInput, TextInputProps>(
  (props, ref) => {
    ...
    const useArabicFont =
      hasArabic && !hasLatin ? true : hasLatin && !hasArabic ? false : false;

    const fontFamily = getFonts(useArabicFont).regular;
    ...
    const platformAdjustments = (() => {
      ...
      if (Platform.OS === 'ios' && flattenedStyle.lineHeight == null) {
        return {
    ...
    return (
      <RNTextInput
        ...
        allowFontScaling={false}
        style={[
          Platform.OS === 'ios' ? { writingDirection: 'ltr' } : null,
          { fontFamily },
          platformAdjustments,
          props.style,
        ]}
